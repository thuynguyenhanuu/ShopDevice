...
public class ChitietdonchoxulyActivity extends AppCompatActivity {
...
//        setContentView(R.layout.ac);
    ...
    private void Getdulieusanphammua() {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, Server.Duongdangetdonchoxuly, new Response.Listener<String>() {
                @Override
...
//
        ...
        private void Events() {
            btnhuydon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    final RequestQueue requestQueue = Volley.newRequestQueue(getApplicationContext());
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, Server.Duongdanhuydon, new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
        ...
        private void Anhxa() {
            ...
            toolbarchoxacnhan.setTitle("Chi tiết đơn chờ xử lý");

...
public class ListDontrahangActivity extends AppCompatActivity {
    ...
    private void Getdulieu() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Server.DuongdangetIDdontrahang, new Response.Listener<String>() {
            @Override
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(getApplicationContext(), ChitietdontrahangActivity.class);
    ...
    private void AnhXa() {
        ...
        toolbar.setTitle("Danh sách đơn trả hàng");

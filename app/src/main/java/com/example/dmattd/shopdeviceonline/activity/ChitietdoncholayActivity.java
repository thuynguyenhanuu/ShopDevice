...
public class ChitietdoncholayActivity extends AppCompatActivity {
...
//            });
        ...
        private void Anhxa() {
            toolbar = findViewById(R.id.toolbarchoxacnhandon);
            toolbar.setTitle("Chi tiết đơn chờ lấy hàng");

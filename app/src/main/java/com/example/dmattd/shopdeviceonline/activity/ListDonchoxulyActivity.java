...
public class ListDonchoxulyActivity extends AppCompatActivity {
    ...
    private void Getdulieu() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Server.DuongdangetIDdonhangchoxuly, new Response.Listener<String>() {
            @Override
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(getApplicationContext(), ChitietdonchoxulyActivity.class);
    ...
    private void AnhXa() {
        ...
        toolbar.setTitle("Danh sách đơn hàng chờ xử lý");

...
public class ListDoncholayhangActivity extends AppCompatActivity {
    ...
    private void Getdulieu() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Server.DuongdangetIDdoncholay, new Response.Listener<String>() {
            @Override
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(getApplicationContext(), ChitietdoncholayActivity.class);

...
//        setContentView(R.layout.ac);
    ...
    private void Getdulieusanphammua() {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, Server.Duongdangetdondanggiao, new Response.Listener<String>() {
                @Override
...
//            });
        ...
        private void Anhxa() {
            ...
            toolbarchoxacnhan.setTitle("Chi tiết đơn hàng đang giao");

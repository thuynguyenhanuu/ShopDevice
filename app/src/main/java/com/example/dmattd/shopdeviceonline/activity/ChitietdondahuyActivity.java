...
//        setContentView(R.layout.ac);
    ...
    private void Getdulieusanphammua() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Server.Duongdangetdondahuy, new Response.Listener<String>() {
            @Override
...
//
    ...
    private void Events() {
        btnhuydon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final RequestQueue requestQueue = Volley.newRequestQueue(getApplicationContext());
                StringRequest stringRequest = new StringRequest(Request.Method.POST, Server.Duongdandatlaidon, new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Toast.makeText(getApplicationContext(),"Đặt lại đơn hàng thành công!", Toast.LENGTH_SHORT).show();
                    }
                }, new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
    ...
    private void Anhxa() {
        ...
        toolbarchoxacnhan.setTitle("Chi tiết đơn đã hủy");

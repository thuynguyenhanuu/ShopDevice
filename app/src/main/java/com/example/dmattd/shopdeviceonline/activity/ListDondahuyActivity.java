...
public class ListDondahuyActivity extends AppCompatActivity {
    ListView listView;
    ...
    private void Getdulieu() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Server.DuongdangetIDdonhangdahuy, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                if(response != null) {
                    Log.wtf("KK", "don da huy: " +response);
                    int iddon =0;
                    String trangthai = "";
                    String time;
                    try {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(getApplicationContext(), ChitietdondahuyActivity.class);
    ...
    private void AnhXa() {
        ...
        toolbar.setTitle("Danh sách đơn hàng đã hủy");

...
public class ChitietdontrahangActivity extends AppCompatActivity {
...
//        setContentView(R.layout.ac);
    ...
    private void Getdulieusanphammua() {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, Server.Duongdangetdontrahang, new Response.Listener<String>() {
                @Override
...
//
//                    final RequestQueue requestQueue = Volley.newRequestQueue(getApplicationContext());
//                    StringRequest stringRequest = new StringRequest(Request.Method.POST, Server.Duongdangetdoncholay, new Response.Listener<String>() {
//                        @Override
//                        public void onResponse(String response) {
//                            Toast.makeText(getApplicationContext(),"Hủy đơn thành công!", Toast.LENGTH_SHORT).show();
//                        }
//                    }, new Response.ErrorListener() {
//                        @Override
//                        public void onErrorResponse(VolleyError error) {
...
//            });
        ...
        private void Anhxa() {
            ...
            toolbarchoxacnhan.setTitle("Chi tiết đơn trả hàng");
